...
CREATE INDEX IF NOT EXISTS idx_chat_web_search_source_message_id ON chat_web_search_source (message_id);
CREATE INDEX IF NOT EXISTS idx_chat_web_search_source_message_rank ON chat_web_search_source (message_id, rank_no);
