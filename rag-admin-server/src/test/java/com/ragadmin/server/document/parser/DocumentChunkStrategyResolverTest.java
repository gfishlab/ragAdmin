...
class DocumentChunkStrategyResolverTest {
    ...
    void shouldSelectFirstMatchingStrategy() {
        ...
        ChunkContext context = ChunkContext.of(null, DocumentSignals.empty(), ChunkStrategyProperties.defaults(), "TEXT");
    ...
    void shouldThrowWhenNoStrategyMatches() {
        ...
        ChunkContext context = ChunkContext.of(doc, DocumentSignals.empty(), ChunkStrategyProperties.defaults(), "TEXT");
